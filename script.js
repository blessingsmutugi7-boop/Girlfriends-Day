...
if (pageMusic) pageMusic.pause();
window.location.href = "letter.html?autoplay=1";
}
...
if (continueButton) {
    ...
    continueButton.addEventListener("click", function () {
        ...
        setTimeout(function () {
            if (pageMusic) pageMusic.pause();
                window.location.href = "memories.html?autoplay=1";
        }, 950);
...
if (slides.length > 0 && finalButton && replayButton) {
    ...
    finalButton.addEventListener("click", function () {
        if (pageMusic) pageMusic.pause();
            window.location.href = "final.html?autoplay=1";
    });
